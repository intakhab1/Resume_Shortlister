...
mypath = 'C:/Users/Intakhab/PycharmProjects/pythonProject4/Resume'
...
# function for condition matching
def create_profile(file, idx):
    ...
    keyword_dict = pd.read_csv(
        'C:/Users/Intakhab/PycharmProjects/pythonProject4/shortlist.csv')
